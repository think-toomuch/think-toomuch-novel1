                        ...
                        <div class="row form-horizontal">
                            ...
                            <div class="col-xs-12 col-sm-3">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="cname" class="form-control" placeholder="请输入章节名">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body" style="padding-left: 12px;padding-top: 10px;padding-bottom: 0px">
                                <a href="/chapter/form" type="button" class="btn btn-default btn-sm"><i class="fa fa-plus"></i>新增</a>&nbsp;&nbsp;&nbsp;
                                <button onclick="App.deleteMulti('/chapter/delete',null)" type="button" class="btn btn-default btn-sm"><i class="fa fa-trash"></i>删除</button>&nbsp;&nbsp;&nbsp;&nbsp;
...
<script>
    ...
    $(function () {
        ...
        dataTable=App.initDataTables("/chapter/page",_columns);
    });
    function search() {
