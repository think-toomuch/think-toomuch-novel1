    ...
    <div class="layui-col-sm12 layui-col-md12">
        <div class="layui-carousel zyl_login_height" id="zyllogin" lay-filter="zyllogin">
            <div carousel-item="">
                ...
                <div>
                    <img src="../../static/assets/img/carousel/01.jpg" />
                </div>
                <div>
                ...
                <div>
                    <img src="../../static/assets/img/carousel/03.jpg" />
                </div>
            </div>
        </div>
    </div>
...
<div class="zyl_lofo_main">
    <fieldset class="layui-elem-field layui-field-title zyl_mar_02">
        <legend>欢迎登陆 - 想太多会累小说管理平台</legend>
    </fieldset>
    <div class="layui-row layui-col-space15">
        <form class="layui-form zyl_pad_01" method="post" action="/login">
            <div class="layui-col-sm12 layui-col-md12">
                <div class="layui-form-item">
                    <input type="text" name="mname" lay-verify="required|userName" value="admin" autocomplete="off" placeholder="账号" class="layui-input">
                    <i class="layui-icon layui-icon-username zyl_lofo_icon"></i>
                </div>
            </div>
            <div class="layui-col-sm12 layui-col-md12">
                <div class="layui-form-item">
                    <input type="password" name="mpwd" lay-verify="required|pass" value="123" autocomplete="off" placeholder="密码" class="layui-input">
...
<%--            </div>--%>
            <div class="layui-col-sm12 layui-col-md12">
                <input class="layui-btn layui-btn-fluid" type="submit" ></input>
...
<!-- Jqarticle Js -->
<script type="text/javascript" src="../../static/assets/assembly/jqarticle/jparticle.min.js"></script>
<!-- ZylVerificationCode Js-->
<script type="text/javascript" src="../../static/assets/assembly/zylVerificationCode/zylVerificationCode.js"></script>
<script>
