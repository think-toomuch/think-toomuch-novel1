                        ...
                        <div class="row form-horizontal">
                            <div class="col-xs-12 col-sm-3">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="nid" type="text" class="form-control" placeholder="请输入小说检索ID">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-3">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="cid" class="form-control" placeholder="请输入章节检索ID">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-3">
                                <div class="form-group row">
                                    <label for="ccontent" class="col-sm-2 col-form-label">章节内容</label>
                                    <div class="col-sm-10">
                                        <input id="ccontent" class="form-control" placeholder="请输入想搜的内容">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body" style="padding-left: 12px;padding-top: 10px;padding-bottom: 0px">
                                <a href="/chaptercontent/form" type="button" class="btn btn-default btn-sm"><i class="fa fa-plus"></i>新增</a>&nbsp;&nbsp;&nbsp;
                                <button onclick="App.deleteMulti('/chaptercontent/delete',null)" type="button" class="btn btn-default btn-sm"><i class="fa fa-trash"></i>删除</button>&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            {"data": "nid"},
            {
                "data": function (row, type, val, meta) {
                    if (row.ccontent == null)
                        return '';
                    //只显示前面5个字符
                    return row.ccontent.substring(0,20)+'...'
                }
            },
            {
                "data": function (row, type, val, meta) {
                    const detailUrl = "/chaptercontent/detail?id=" + row.id;
                    const id=row.id;
                    return '<button type="button" onclick="App.showDetail(\''+detailUrl+'\')" class="btn btn-default btn-sm"><i class="fa fa-search"></i>查看</button>\n' +
                        '<a href="/chaptercontent/form?id=' + row.id + '" type="button" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i>修改</a>\n' +
                        '<button onclick="App.deleteMulti(\'/chaptercontent/delete\',\''+id+'\')" type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i>删除</button>';
                }
            }
        ];
        dataTable=App.initDataTables("/chaptercontent/page",_columns);
    });
    function search() {
